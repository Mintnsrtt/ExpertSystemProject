 ...
 * @author Asus
 */
public class ชาย_สั้น_สากล_ไม่สวมหมวก extends javax.swing.JFrame {

    /**
     * Creates new form ชาย_สั้น_สากล_ไม่ส่วมหมวก
     */
    public ชาย_สั้น_สากล_ไม่สวมหมวก() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("สมัยรัตนโกสินทร์ รัชกาลที่ ๖ - ๗");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ES/สั้น-ไม่สวมหมวก.jpg"))); // NOI18N

        jTextArea1.setColumns(20);
        jTextArea1.setFont(new java.awt.Font("DSU_MaiThai", 0, 24)); // NOI18N
        jTextArea1.setRows(5);
        jTextArea1.setText("         ในสมัยรัชกาลที่ ๖ - ๗ บุรุษเริ่มมีการไว้ผมยาวขึ้น\nหรือไว้ผมยาวอย่างแบบสากลของฝรั่ง  สตรีมีการดัด\nลอนเพื่อความสวยงามตามแบบสากล ที่นิยมกันในหมู่\nราชสำนักหรือคนกรุง ส่วนชาวบ้านยังคงไว้ผมดอกกระทุ่ม\nหรือผมตัดกันอยู่มาก ต่อมาจึงค่อยมีการเปลี่ยนแปลงกัน\nมากขึ้น");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ชาย_สั้น_สากล_ไม่สวมหมวก.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
