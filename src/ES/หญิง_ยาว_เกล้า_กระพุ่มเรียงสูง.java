 ...
 * @author Asus
 */
public class หญิง_ยาว_เกล้า_กระพุ่มเรียงสูง extends javax.swing.JFrame {

    /**
     * Creates new form หญิง_ยาว_เกล้า_กระพุ่มเรียงสูง
     */
    public หญิง_ยาว_เกล้า_กระพุ่มเรียงสูง() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("สมัยศรีวิชัย");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ES/ยาว-เกล้า-พุ่มเรียงสูง.jpg"))); // NOI18N
        jLabel2.setText("jLabel2");

        jTextArea1.setColumns(20);
        jTextArea1.setFont(new java.awt.Font("DSU_MaiThai", 0, 24)); // NOI18N
        jTextArea1.setRows(5);
        jTextArea1.setText("       ช่วงพุทธศตวรรษที่ ๑๓ - ๑๘ บุรุษเกล้ามวยเป็น\nกระพุ่มเรียงสูง  คือการเกล้ามวยทรงกระบอกสูงเรียบๆ\nประดับด้วยเครื่องประดับ  ปล่อยปลายผมสยายลงรอบ\nศรีษะเป็นชั้นๆ บางทีปล่อยชายผมชั้นล่างสยายลงประบ่า\nกรอบพักตร์หรือกระบังหน้าทำด้วยทองคำประดับเพชร\nพลอยไปทั้งสองข้างต่อด้วยผ้าหรือเกลียวไหมซึงดึงรั้ง\nมาผูกเป็นโบว์หลังศรีษะ  ส่วนผมที่มุ่นเป็นมวยก็มีกรอง\nทองสนองเกล้าครอบประดับไว้");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(หญิง_ยาว_เกล้า_กระพุ่มเรียงสูง.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
