 ...
 * @author Asus
 */
public class ชาย_ยาว_มวยผมไว้หลังท้ายทอย extends javax.swing.JFrame {

    /**
     * Creates new form ชาย_ยาว_มวยผมไว้หลังท้ายทอย
     */
    public ชาย_ยาว_มวยผมไว้หลังท้ายทอย() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("สมัยทวารวดี ถึง ปัจจุบัน");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ES/พราหมณ์.jpg"))); // NOI18N

        jTextArea1.setColumns(20);
        jTextArea1.setFont(new java.awt.Font("DSU_MaiThai", 0, 24)); // NOI18N
        jTextArea1.setRows(5);
        jTextArea1.setText("          พุทธศตวรรษที่ ๑๑ - ๑๖  พราหมณ์จะไว้ผมยาว\nมั่นเป็นมวยไว้ด้านหลังท้ายทอย มักไม่สวมเครื่องประดับ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ชาย_ยาว_มวยผมไว้หลังท้ายทอย.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
